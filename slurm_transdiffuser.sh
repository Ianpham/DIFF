...
# Updated for SuperPod: vinfast_tamp@sdc2-hpc-login-mgmt001

echo "=========================================="
echo "Transdiffuser Project Setup (SuperPod)"
echo "=========================================="
echo ""
...
#!/bin/bash
# Transdiffuser Complete Environment Setup (SuperPod)
...
if [[ -n "$PYTHONPATH" ]]; then
    DDPM_PATH="/lustre/scratch/client/vinfast/users/vinfast_tamp/data/DPJI/transdiffuser/DDPM"
