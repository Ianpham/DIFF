...
# ============================================================
# Paper config: lr=1e-4, batch=64/GPU, β=0.02, T=10, Adam + OneCycle
# Effective batch: 64 × 2 = 128 (half of 4-GPU run)
#
# NOTE: If convergence differs from 4-GPU run, consider:
#   - Doubling batch_size to 128 to match effective 256 (watch OOM)
#   - Or scaling lr down to ~7e-5 (linear scaling rule)
